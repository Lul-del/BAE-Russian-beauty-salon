        ...
        <div ref={ref} className="grid md:grid-cols-2 gap-10 md:gap-12 lg:gap-16 items-center">
          ...
          <div className={`relative transition-all duration-700 ${inView ? 'opacity-100 translate-x-0' : 'opacity-0 -translate-x-10'}`}>
            <div className="relative mx-6 sm:mx-8">
              ...
              <div className="absolute -bottom-4 -right-4 sm:-bottom-6 sm:-right-6 bg-white dark:bg-gray-800 rounded-xl sm:rounded-2xl p-3 sm:p-5 shadow-xl shadow-rose-100/50 dark:shadow-gray-900/50 border border-rose-50 dark:border-gray-700">
                <div className="flex items-center gap-2 sm:gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-xs sm:text-sm text-gray-500 dark:text-gray-400">Clients satisfaits</p>
                  </div>
                </div>
              </div>
              <div className="absolute -top-3 -left-3 sm:-top-4 sm:-left-4 bg-white dark:bg-gray-800 rounded-xl sm:rounded-2xl p-3 sm:p-4 shadow-xl shadow-rose-100/50 dark:shadow-gray-900/50 border border-rose-50 dark:border-gray-700">
          ...
          <div className={`transition-all duration-700 delay-200 ${inView ? 'opacity-100 translate-x-0' : 'opacity-0 translate-x-10'}`}>
            <span className="inline-flex items-center gap-2 text-[#ED5389] dark:text-[#D4AF37] font-medium text-xs sm:text-sm uppercase tracking-widest mb-3">
              <Sparkles className="w-3.5 h-3.5 sm:w-4 sm:h-4" /> À propos de nous
            </span>
            ...
            <div className="grid grid-cols-3 gap-2 sm:gap-4 mb-6 sm:mb-8">
              {[
                { icon: <Eye className="w-5 h-5 sm:w-6 sm:h-6" />, label: 'Cils', color: 'from-pink-500 to-rose-400' },
                { icon: <Scissors className="w-5 h-5 sm:w-6 sm:h-6" />, label: 'Cheveux', color: 'from-amber-500 to-yellow-400' },
                { icon: <Hand className="w-5 h-5 sm:w-6 sm:h-6" />, label: 'Ongles', color: 'from-purple-500 to-violet-400' },
              ].map((item, i) => (
            ...
            <a href="#contact" className="inline-flex items-center gap-2 px-5 sm:px-6 py-2.5 sm:py-3 rounded-full bg-linear-to-r from-[#FF61EF] to-[#ED5389] dark:from-[#D4AF37] dark:to-[#D4AF37] text-white font-semibold shadow-lg transition-all hover:scale-105 text-sm sm:text-base">
              Nous contacter <ArrowRight className="w-4 h-4 sm:w-5 sm:h-5" />
            </a>
          </div>
        </div>
      </div>
