import { Eye, Palette, Wand2, Gem } from 'lucide-react';
...
export default function Gallery() {
  ...
  const items = [
    { image: img1, label: t.gallery.lashes, sublabel: t.gallery.lashesSub, icon: <Eye className="w-5 h-5" /> },
    { image: img2, label: t.gallery.nailArt, sublabel: t.gallery.nailArtSub, icon: <Palette className="w-5 h-5" /> },
    { image: img3, label: t.gallery.lashLift, sublabel: t.gallery.lashLiftSub, icon: <Wand2 className="w-5 h-5" /> },
    { image: img4, label: t.gallery.manicure, sublabel: t.gallery.manicureSub, icon: <Gem className="w-5 h-5" /> },
  ];
  ...
  return (
    <section id="galerie" className="py-16 sm:py-24 bg-linear-to-b from-rose-50/50 to-white dark:from-gray-950 dark:to-gray-900">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <SectionTitle sub={t.gallery.sub} title={t.gallery.title} desc={t.gallery.desc} />
