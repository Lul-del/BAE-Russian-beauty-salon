        ...
        <div className="py-12 grid md:grid-cols-4 gap-8">
          <div className="md:col-span-2">
            <div className="flex items-center gap-3 mb-4">
              ...
              <div className="flex flex-col leading-tight">
                <span className="font-display font-bold text-base text-white">BAE Russian beauty salon</span>
          ...
          <div>
            ...
            <ul className="space-y-2 text-sm text-white/50">
              ...
              <li className="flex items-center gap-2"><Phone className="w-3.5 h-3.5 shrink-0" /> +971 58 531 0080</li>
              <li className="flex items-center gap-2"><Mail className="w-3.5 h-3.5 shrink-0" /> baebeautysalon@gmail.com</li>
              <li className="flex items-center gap-2"><Clock className="w-3.5 h-3.5 shrink-0" /> Lun-Dim : 10h-21h</li>
            </ul>
          </div>
        </div>

        {/* Bottom */}
        <div className="py-6 border-t border-white/10 flex flex-col sm:flex-row items-center justify-between gap-4 text-sm text-white/30">
